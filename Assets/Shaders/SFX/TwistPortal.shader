    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_8831_ang = node_3325.g;
...
////// Emissive:
                ...
                float2 node_2191 = (i.uv0+node_3325.g*float2(0.2,0.2));
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_2191, _Noise));
                float node_707 = (_TwistEmissive_var.b*0.65*(_Noise_var.b*0.5));
                float3 emissive = (_Color.rgb*(node_1934+node_707));
                float3 finalColor = emissive;
                float node_9563 = (node_1934+(node_707*_Circle_var.b));
                return fixed4(lerp(sceneColor.rgb, finalColor,node_9563),1);
            }
            ENDCG
        }
    }
