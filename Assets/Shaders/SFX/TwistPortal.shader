    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_8831_ang = node_8326.g;
...
////// Emissive:
                ...
                float2 node_2191 = (i.uv0+node_8326.g*float2(0.2,0.2));
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(node_2191, _Noise));
                float3 node_707 = (_TwistEmissive_var.b*0.65*(_Noise_var.rgb*0.5));
